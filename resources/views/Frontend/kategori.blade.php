...
@foreach ($Lainnya as $data)
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(img/img2/{{$data->cover1}});">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					...
					<h4 class="m-text14 p-b-7">
						...
						<ul class="p-b-54">
							...
							<li class="p-t-4">
								<a href="/produk" class="s-text13 active1">
									Semua Produk
								</a>
							</li>
							@foreach ($kategori as $data)
							<li class="p-t-4">
								<a href="{{route('showperkategori', $data->slug)}}" class="s-text13">
									{{$data->nama_kategori}}
								</a>
							</li>
							@endforeach
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2">
									<img src="{{asset('/img/img1/'.$data->cover.'')}}" alt="IMG-PRODUCT" height="350">

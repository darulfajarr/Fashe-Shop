          ...
          <tr>
            ...
            <td>
              <form action="{{route('Product.destroy',$data->id)}}" method="post">
                ...
                <a data-toggle="tooltip" data-placement="top" title="Edit Data" class="btn btn-success" href="/Backend/Product/{{$data->id}}/edit"><i class="fa fa-edit"></i></a>
                <button data-toggle="tooltip" data-placement="top" title="Hapus Data" type="submit" class="btn btn-danger" onclick="return confirm('Anda Yakin Akan Menghapus ?')"><i class="fa fa-trash"></i></button>
                 <a data-toggle="tooltip" data-placement="top" title="Detail Data" class="btn btn-success" href="/Backend/Product/{{$data->id}}"><i class="fa fa-info"></i></a>
              {{csrf_field()}}
              </form>
            </td>
          </tr>

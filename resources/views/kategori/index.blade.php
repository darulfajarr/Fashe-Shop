...
@section('content')
  <ol class="breadcrumb">
    <h4>
        <li><i class="fa fa-dashboard"></i> Data Kategori</li>
    </h4>
      </ol>
<br><br><br><br>
...
<div class="box">
  ...
  &nbsp&nbsp<a class="btn btn-primary" href="{{ route('kategori.create') }}">Tambah</a>
    <!-- /.box-header -->
    <div class="box-body">
        ...
        <tbody>
          ...
          <td>
              <form action="{{route('kategori.destroy',$data->id)}}" method="post">
                ...
                <a data-toggle="tooltip" data-placement="top" title="Edit Data" class="btn btn-success" href="/admin/kategori/{{$data->id}}/edit"><i class="fa fa-edit"></i></a>
